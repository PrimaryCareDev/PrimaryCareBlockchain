        ...
        <div className="min-h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <div>
                    ...
                    className="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in as Patient</h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or{' '}
                        <Link to="/patientRegister" className="font-medium text-indigo-600 hover:text-indigo-500">
            ...
            <div
                ...
                <p>Are you a doctor? {' '} <Link to="/doctor"
